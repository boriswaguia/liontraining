...
const adminIcons = [School, Building2, Users, BookOpen, UserCog, Activity];
const adminHrefs = ["/admin/schools", "/admin/departments", "/admin/classes", "/admin/courses", "/admin/users", "/admin/activity"];
const adminKeys = ["nav.admin.schools", "nav.admin.departments", "nav.admin.classes", "nav.admin.courses", "nav.admin.users", "nav.admin.activity"] as const;
