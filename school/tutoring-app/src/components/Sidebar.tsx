...
const adminIcons = [School, Building2, Users, BookOpen, UserCog, Activity, BarChart3, Coins, Settings, HardDrive];
const adminHrefs = ["/admin/schools", "/admin/departments", "/admin/classes", "/admin/courses", "/admin/users", "/admin/activity", "/admin/analytics", "/admin/credit-packs", "/admin/settings", "/admin/backup"];
const adminKeys = ["nav.admin.schools", "nav.admin.departments", "nav.admin.classes", "nav.admin.courses", "nav.admin.users", "nav.admin.activity", "nav.admin.analytics", "nav.admin.creditPacks", "nav.admin.settings", "nav.admin.backup"] as const;
